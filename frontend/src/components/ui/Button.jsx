...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-manipulation min-h-[44px]", // Added min-height for touch targets
    {
        variants: {
            variant: {
            ...
            size: {
                default: "h-11 px-4 py-2 text-base", // Increased default size for mobile
